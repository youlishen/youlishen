...
public class PhoneNumberListAdapter extends ContactEntryListAdapter {
  ...
  public DialerContact getDialerContact(int position) {
    ...
    LogUtil.e("PhoneNumberListAdapter.getDialerContact", "cursor: " + cursor);
    if (cursor == null) {
  ...
  protected ContactListItemView newView(
    ...
    LogUtil.e("PhoneNumberListAdapter.newView", "view: " + view);
    return view;
  }
  ...
  protected void bindView(View itemView, int partition, Cursor cursor, int position) {
    ...
    for (int i = 0; i<cursor.getColumnCount(); i++) {
      LogUtil.d(TAG, "bindView [" + i + "]: " + cursor.getColumnName(i));
    }
  ...
  public static class PhoneQuery {
    ...
    public static final int ORDER_INFO = 10;
    ...
    static {
      ...
      projectionList.add(WuLiuContant.COLUMN_NAME_ORDER_INFO); // 10
