...
public class ViewPagerTabs extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
  ...
  public ViewPagerTabs(Context context, AttributeSet attrs, int defStyle) {
    ...
    final TypedArray b = context.obtainStyledAttributes(attrs, R.styleable.ViewPagerTabs);
    ...
    int resId = b.getColor(R.styleable.ViewPagerTabs_tabs_background_color,
      context.getColor(R.color.actionbar_background_color));
    mTabStrip = new ViewPagerTabStrip(context, resId);
    addView(
        mTabStrip,
