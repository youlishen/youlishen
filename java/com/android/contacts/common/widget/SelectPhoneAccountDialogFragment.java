...
public class SelectPhoneAccountDialogFragment extends DialogFragment {
  ...
  public static SelectPhoneAccountDialogFragment newInstance(
    ...
    LogUtil.i("SelectPhoneAccountDialogFragment", "wanghongjian---accountHandles = "
            + accountHandles + "callId = " + callId + " listener = " + listener);
    if (accountHandles != null) {
      accountHandlesCopy.addAll(accountHandles);
    }
	
	LogUtil.i("SelectPhoneAccountDialogFragment","wanghongjian---accountHandlesCopy = "+accountHandlesCopy);
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    LogUtil.i("SelectPhoneAccountDialogFragment", "wanghongjian---mAccountHandles = " + mAccountHandles);
    ...
    final DialogInterface.OnClickListener selectionListener =
        new DialogInterface.OnClickListener() {
          ...
          public void onClick(DialogInterface dialog, int which) {
            ...
            LogUtil.i("SelectPhoneAccountDialogFragment", "wanghongjian---selectedAccountHandle = "
                    + selectedAccountHandle + "getCallId() = " + getCallId());
  ...
  private static class SelectAccountListAdapter extends ArrayAdapter<PhoneAccountHandle> {
   ...
   /*wanghongjian add change string*/ 
	  ...
	  LogUtil.i("SelectPhoneAccountDialogFragment","wanghongjian---getView--account.getLabel() = "+account.getLabel()+"account = "+account);
