  ...
  public void setPhoneCallDetails(PhoneCallDetailsViews views, PhoneCallDetails details) {
   ...
   /*wanghongjian add change string*/ 
    ...
    if (TextUtils.isEmpty(nameText)) {
      views.nameView.setVisibility(View.GONE);
    } else {
      views.nameView.setVisibility(View.VISIBLE);
      views.nameView.setText(nameText);
    }
    views.numberView.setText(displayNumber);
    if (TextUtils.isEmpty(details.orderNumber)) {
      views.orderNumberView.setVisibility(View.GONE);
      views.orderHintView.setVisibility(View.GONE);
    } else {
      views.orderNumberView.setVisibility(View.VISIBLE);
      views.orderHintView.setVisibility(View.VISIBLE);
      views.orderNumberView.setText(details.orderNumber);
    }
