...
public final class PhoneCallDetailsViews {
  ...
  public final TextView orderHintView;
  ...
  public static PhoneCallDetailsViews fromView(View view) {
    return new PhoneCallDetailsViews(
      (TextView) view.findViewById(R.id.wu_liu_number),
      (TextView) view.findViewById(R.id.wu_liu_order_number_hint),
      (TextView) view.findViewById(R.id.wu_liu_order_number_content),
