...
import com.urovo.dialercloud.mine.MineFragment;
...
public class DialtactsPagerAdapter extends FragmentPagerAdapter {
  ...
  @IntDef({TAB_INDEX_SPEED_DIAL, TAB_INDEX_HISTORY, TAB_INDEX_ALL_CONTACTS,
          TAB_INDEX_ACCOUNT_MINE, TAB_INDEX_VOICEMAIL})
  public @interface TabIndex {}

  public static final int TAB_INDEX_SPEED_DIAL = 0;
  public static final int TAB_INDEX_HISTORY = 1;
  public static final int TAB_INDEX_ALL_CONTACTS = 2;
  public static final int TAB_INDEX_ACCOUNT_MINE = 3;// 20210428 add by duanyongyuan
  public static final int TAB_INDEX_VOICEMAIL = 4;
  ...
  private MineFragment mineFragment;// 20210428 add by duanyongyuan
  private NewSearchFragment newSearchFragment;// 20210428 add by duanyongyuan
  ...
  public Fragment getItem(int position) {
    LogUtil.d("ViewPagerAdapter.getItem", "position: %d, useNewSpeedDialTab:%b, useNewContactsTab: %b",
      position, useNewSpeedDialTab, useNewContactsTab);
...
//        }
        if (newSearchFragment == null) {
          newSearchFragment = NewSearchFragment.newInstance(true);
        }
      ...
      case TAB_INDEX_ACCOUNT_MINE:// 20210428 add by duanyongyuan
  ...
  public Fragment instantiateItem(ViewGroup container, int position) {
    ...
    } else if (fragment instanceof MineFragment) {// 20210428 add by duanyongyuan
      mineFragment = (MineFragment) fragment;
    } else if (fragment instanceof NewSearchFragment) {// 20210428 add by duanyongyuan
