...
public class ListsFragment extends Fragment
  ...
  public View onCreateView(
    ...
    actionTypeList[DialtactsPagerAdapter.TAB_INDEX_ACCOUNT_MINE] =
            UiAction.Type.CHANGE_TAB_TO_CONTACTS;// TODO duanyongyuan
    ...
    swipeImpressionList[DialtactsPagerAdapter.TAB_INDEX_ACCOUNT_MINE] =
            DialerImpression.Type.SWITCH_TAB_TO_CONTACTS_BY_SWIPE;// TODO duanyongyuan
    ...
    clickImpressionList[DialtactsPagerAdapter.TAB_INDEX_ACCOUNT_MINE] =
            DialerImpression.Type.SWITCH_TAB_TO_CONTACTS_BY_CLICK;// TODO duanyongyuan
    ...
    tabTitles[DialtactsPagerAdapter.TAB_INDEX_SPEED_DIAL] =
        getResources().getString(com.android.dialer.R.string.description_dial_button);
    ...
    tabTitles[DialtactsPagerAdapter.TAB_INDEX_ACCOUNT_MINE] =// 20210428 add by duanyongyuan
            getResources().getString(R.string.tab_all_account_mine);
  ...
  public void showTab(int index) {
    ...
    if (index == DialtactsPagerAdapter.TAB_INDEX_ACCOUNT_MINE) {
  ...
  public NewSearchFragment getSearchFragment() {
    if (adapter != null) {
      return (NewSearchFragment) adapter.getItem(DialtactsPagerAdapter.TAB_INDEX_SPEED_DIAL);
    }
    return null;
  }
  ...
  public void setResultContent(Bundle bundle) {
    if (adapter != null) {
      ((NewSearchFragment) adapter
        .getItem(DialtactsPagerAdapter.TAB_INDEX_SPEED_DIAL))
        .setResultContent(bundle);
    }
  }
}
