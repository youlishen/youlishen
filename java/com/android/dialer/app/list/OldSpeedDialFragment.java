...
public class OldSpeedDialFragment extends Fragment
  ...
  public void onResume() {
    ...
    if (PermissionsUtil.hasContactsReadPermissions(getContext())) {
      ...
      // 20210428 modified by duanyongyuan start
      emptyView.setDescription(R.string.tracking_use_hint_information);
      emptyView.setActionLabel(R.string.call_log_all_empty_action);
      // 20210428 modified by duanyongyuan end
    } else {
  ...
  public View onCreateView(
    ...
    emptyView.setImage(EmptyContentView.NO_LABEL); // 20210428 modified by duanyongyuan
