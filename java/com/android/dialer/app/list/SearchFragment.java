...
public class SearchFragment extends PhoneNumberPickerFragment {
  ...
  public void onStart() {
    ...
    LogUtil.d(TAG, "onStart activity: " + activity.getClass().getSimpleName());
    ...
    listView.setOnScrollListener(
        new OnScrollListener() {
          ...
          public void onScrollStateChanged(AbsListView view, int scrollState) {
            LogUtil.d(TAG, this.getClass().getSimpleName() + " setOnScrollListener onScrollStateChanged scrollState=" + scrollState);
          ...
          public void onScroll(
            ...
            LogUtil.d(TAG, this.getClass().getSimpleName() + " setOnScrollListener onScroll totalItemCount="
  ...
  public void updatePosition(boolean animate) {
    LogUtil.d(TAG, "updatePosition animate: %b", animate);
    if (activity == null) {
