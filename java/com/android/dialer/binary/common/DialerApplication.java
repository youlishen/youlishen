...
import org.litepal.LitePalApplication;// 20210428 add by duanyongyuan

/** A common application subclass for all Dialer build variants. */
public abstract class DialerApplication extends LitePalApplication implements HasRootComponent {
  ...
  public void onCreate() {
    ...
    WuLiuManager.initManager(getApplicationContext());
