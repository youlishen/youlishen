...
public class CallDetailsActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    orderInfoView = findViewById(R.id.wu_liu_order_layout);
  ...
  private void updateOrderInfo() {
    LogUtil.d(TAG, "updateOrderInfo");
    if (contact == null || TextUtils.isEmpty(contact.getNumber())) {
      return;
    }
    LogUtil.d(TAG, "updateOrderInfo getNumber=" + contact.getNumber()
      + "; getDisplayNumber=" + contact.getDisplayNumber());
    WuLiuExecutor.execute(()->{
      WuLiuOrderInfoBean bean = WuLiuManager.getInstance().syncQueryOrderByOrderNum(contact.getNumber());
  ...
  private void updateView(WuLiuOrderInfoBean bean) {
    ...
    TextView orderNumber = orderInfoView.findViewById(R.id.wu_liu_order_number_content);
    orderNumber.setText(bean.getOrderNumber());
    TextView name = orderInfoView.findViewById(R.id.wu_liu_order_name_content);
    name.setText(bean.getName());
    TextView address = orderInfoView.findViewById(R.id.wu_liu_order_address_content);
