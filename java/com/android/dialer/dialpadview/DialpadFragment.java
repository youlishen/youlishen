...
public class DialpadFragment extends Fragment
  ...
  private ImageButton floatingActionButton;//FloatingActionButton
  ...
  /* package */ static boolean canAddDigit(CharSequence digits, int start, int end, char newDigit) {
    LogUtil.i("DialpadFragment", "wanghongjian---canAddDigit---digits = " + digits + "start = "
            + start + " end = " + end + " newDigit = " + newDigit);
  ...
  public void onTextChanged(CharSequence input, int start, int before, int changeCount) {
    LogUtil.i("DialpadFragment", "wanghongjian---onTextChanged---input = " + input + "start = "
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedState) {
    ...
    fragmentView
        ...
        .setOnTouchListener(
            (v, event) -> {
              LogUtil.i("DialpadFragment.onCreateView", "dialpad spacer touched event:" + event);
              LogUtil.i("DialpadFragment.onCreateView", "dialpad spacer touched view:" + v);
              if (isDigitsEmpty()) {
                if (getActivity() != null) {
  ...
  private void configureKeypadListeners(View fragmentView) {
	...
	LogUtil.i("DialpadFragment","wanghongjian---configureKeypadListeners");
  ...
  public void onPressed(View view, boolean pressed) {
    ...
    LogUtil.i("DialpadFragment","wanghongjian---onPressed---pressed = "+pressed);
    if (pressed) {
  ...
  public void onClick(View view) {
    ...
    LogUtil.i("DialpadFragment", "wanghongjian---onClick---resId = " + resId);
  ...
  public boolean onLongClick(View view) {
    ...
    LogUtil.i("DialpadFragment", "wanghongjian---id = " + id);
    switch (id) {
      ...
      case R.id.nine:
        ...
        LogUtil.i("DialpadFragment", "wanghongjian---this.digits.length() = " + this.digits.length());
  ...
  private void showNoSpeedNumberDialog(final int number) {
    new AlertDialog.Builder(getActivity())
        ...
        .setMessage(getString(com.android.dialer.R.string.speed_dial_unassigned_dialog_message, number))
        .setPositiveButton(com.android.dialer.R.string.yes, new DialogInterface.OnClickListener() {
          @Override
        ...
        .setNegativeButton(com.android.dialer.R.string.no, null)
        .show();
  }
