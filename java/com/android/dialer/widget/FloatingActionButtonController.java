...
public class FloatingActionButtonController {
  ...
  private final ImageButton fab;//FloatingActionButton
  private final Interpolator fabInterpolator;
  private int fabIconId = -1;
  private int screenWidth;
  private final int tabOffsetY;

  public FloatingActionButtonController(Activity activity, ImageButton fab) {//FloatingActionButton
    ...
    tabOffsetY = resources.getDimensionPixelSize(com.android.dialer.R.dimen.tab_height);
    this.fab = fab;
  }
  ...
  private void align(int align, int offsetX, int offsetY, boolean animate) {
    ...
    offsetY = -tabOffsetY * (isLayoutRtl() ? -1 : 1);
