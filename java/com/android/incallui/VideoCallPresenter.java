...
public class VideoCallPresenter
  ...
  public int mIsOutgoingVideoCall = 0;
  /**
  ...
  public void onCameraDimensionsChange(DialerCall call, int width, int height) {
	...
	if(isOutgoingVideoCall(call)){
		mIsOutgoingVideoCall = 1;
	}else{
		mIsOutgoingVideoCall = 0;
	}
	Settings.System.putInt(context.getContentResolver(),"mIsOutgoingVideoCall",mIsOutgoingVideoCall);
  	Log.i("VideoCallPresenter","onCameraDimensionsChange ---mIsOutgoingVideoCall = "+mIsOutgoingVideoCall);
    if (videoCallScreen == null) {
