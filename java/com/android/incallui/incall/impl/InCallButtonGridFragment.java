...
public class InCallButtonGridFragment extends Fragment {
  ...
  private static final int BUTTON_COUNT = 7;//Jeff_wei change for Call record from 6 to 7
  private static final int BUTTONS_PER_ROW = 4;//Jeff_wei change for Call record from 3 to 4
  ...
  public View onCreateView(
	...
	buttons[6] = ((CheckableLabeledButton) view.findViewById(R.id.incall_seventh_button));//Jeff_wei change for Call record 
