...
public interface InCallButtonUiDelegate {
  ...
  void changeToVideoClicked(int videoState);   //Jeff_weisy [S]20190402 for video to voice add
  ...
  void swapSimClicked();
  void recordCallClicked(boolean checked);    //wanghongjian 20190215 add for call record   
