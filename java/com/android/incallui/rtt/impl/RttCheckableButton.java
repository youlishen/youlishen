...
public class RttCheckableButton extends Button implements Checkable {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    contentDescriptionChecked =
        typedArray.getText(R.styleable.RttCheckableButton_contentDescriptionCheckedRTT);
    contentDescriptionUnchecked =
        typedArray.getText(R.styleable.RttCheckableButton_contentDescriptionUncheckedRTT);
    typedArray.recycle();
