...
import android.telecom.VideoProfile;  //Jeff_weisy 20190402 for video to voice add
...
public class VideoCallFragment extends Fragment
  ...
  private boolean mIsBackFacingCamera = false;
  ...
  private ImageButton switchvoicecallButton;//Jeff_weisy 20190402 for video to voice add
  private CallAudioState current_audioState;//Jeff_weisy 20190426 added abnormal case BugID=53815
...
//Jeff_weisy [S] 20190413 added here for BugID=53815
  if(current_audioState.getRoute()==CallAudioState.ROUTE_SPEAKER)//Jeff_weisy 20190426 added
  {
    inCallButtonUiDelegate.toggleSpeakerphone();
    videoCallScreenDelegate.resetAutoFullscreenTimer();
  }
//Jeff_weisy [E] 20190413 added here for BugID=53815
...
//Jeff_weisy [E]20190402 for video to voice add
  ...
  public void setCameraSwitched(boolean isBackFacingCamera) {
    mIsBackFacingCamera = isBackFacingCamera;
  ...
  public void setAudioState(CallAudioState audioState) {
    ...
    current_audioState=audioState;//Jeff_weisy 20190426 added abnormal case BugID=53815
  ...
  private void updatePreviewVideoScaling() {
    ...
    int isoutgoingvideocall = Settings.System.getInt(getContext().getContentResolver(), "mIsOutgoingVideoCall", 0);
    LogUtil.i("VideoCallFragment", "updatePreviewVideoScaling ---isoutgoingvideocall = "
            + isoutgoingvideocall + " mIsBackFacingCamera = " + mIsBackFacingCamera);
	if((isoutgoingvideocall == 1)&&mIsBackFacingCamera){
	    if (isLandscape()) {
	      VideoSurfaceBindings.scaleVideoAndFillView(
	          previewTextureView,
	          cameraDimensions.x,
	          cameraDimensions.y,
	          videoCallScreenDelegate.getDeviceOrientation()+180.0f);
	    } else {
	      VideoSurfaceBindings.scaleVideoAndFillView(
	          previewTextureView,
	          cameraDimensions.y,
